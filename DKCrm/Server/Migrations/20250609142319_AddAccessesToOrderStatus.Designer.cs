...
namespace DKCrm.Server.Migrations
{
    ...
    [Migration("20250609142319_AddAccessesToOrderStatus")]
    partial class AddAccessesToOrderStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OrderModels.ExportedOrderStatus", b =>
                {
                    ...
                    b.Property<int>("LimitPositionToEditOrder")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("UsersWitchAccess")
                        .HasMaxLength(400)
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OrderModels.ImportedProduct", b =>
                {
                    ...
                    b.Property<Guid?>("PriceForImportOfferId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PriceForImportOfferId");
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OrderModels.ImportedProduct", b =>
                {
                    ...
                    b.HasOne("DKCrm.Shared.Models.OfferModels.PriceForImportOffer", "PriceForImportOffer")
                        .WithMany("ImportedProducts")
                        .HasForeignKey("PriceForImportOfferId");
                    ...
                    b.Navigation("PriceForImportOffer");
