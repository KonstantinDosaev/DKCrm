...
namespace DKCrm.Server.Migrations
{
    ...
    [Migration("20250426105304_AddImpProdImpOfferLink")]
    partial class AddImpProdImpOfferLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.ExportProductPriceImportOffer", b =>
                {
                    ...
                    b.HasKey("ExportedProductId", "PriceId");
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.ImportProductPriceImportOffer", b =>
                {
                    ...
                    b.HasKey("ImportedProductId", "PriceId");

                    b.HasIndex("PriceId");

                    b.ToTable("ImportProductPriceImportOffers", (string)null);
                });
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.ImportProductPriceImportOffer", b =>
                {
                    b.HasOne("DKCrm.Shared.Models.OrderModels.ImportedProduct", "ImportedProduct")
                        .WithMany("ImportProductPriceImportOffers")
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.PriceForImportOffer", b =>
                {
                    ...
                    b.Navigation("ImportProductPriceImportOffers");
                });
