...
namespace DKCrm.Server.Migrations
{
    ...
    [Migration("20250403183958_AddQuantittyToOrderOffer")]
    partial class AddQuantittyToOrderOffer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.ExportedProductImportOffer", b =>
                {
                    b.Property<Guid>("ExportedProductsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ImportOffersId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ExportedProductsId", "ImportOffersId");

                    b.HasIndex("ImportOffersId");

                    b.ToTable("ExportedProductImportOffer", (string)null);
                });
            ...
            modelBuilder.Entity("ImportOfferImportedProduct", b =>
                {
                    b.Property<Guid>("ImportOffersId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("ImportedProductsId")
                        .HasColumnType("uuid");

                    b.HasKey("ImportOffersId", "ImportedProductsId");

                    b.HasIndex("ImportedProductsId");

                    b.ToTable("ImportOfferImportedProduct");
                });
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.ExportedProductImportOffer", b =>
                {
                    b.HasOne("DKCrm.Shared.Models.OrderModels.ExportedProduct", "ExportedProducts")
                        .WithMany("ExportedProductImportOffer")
                        .HasForeignKey("ExportedProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DKCrm.Shared.Models.OfferModels.ImportOffer", "ImportOffers")
                        .WithMany("ExportedProductImportOffer")
                        .HasForeignKey("ImportOffersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ImportOfferImportedProduct", b =>
                {
                    b.HasOne("DKCrm.Shared.Models.OfferModels.ImportOffer", null)
                        .WithMany()
                        .HasForeignKey("ImportOffersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DKCrm.Shared.Models.OrderModels.ImportedProduct", null)
                        .WithMany()
                        .HasForeignKey("ImportedProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DKCrm.Shared.Models.OfferModels.ImportOffer", b =>
                {
                    b.Navigation("ExportedProductImportOffer");
