...
namespace DKCrm.Server.Migrations
{
    ...
    [Migration("20240120211059_AddSoftDeleted")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationOrderingProductsProduct", b =>
                {
                    b.HasOne("DKCrm.Shared.Models.OrderModels.ApplicationOrderingProducts", null)
                        .WithMany()
                        .HasForeignKey("ApplicationOrderingListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DKCrm.Shared.Models.Products.Product", null)
                        .WithMany()
